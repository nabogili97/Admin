    ...
    <div class="row">
      ...
      <div class="col-md-10 pl-0">
        ...
        <div class="pl-5 pr-5 pt-5 pb-0">
           ...
           <Receipts v-bind:receipts="receipts"  />
...
export default {
  components: { Receipts, MenuHead, MenuLeft, BrandSearchForm, Pagination },
    data: function () {
      return {
        receipts: [],
        search: " ",
    ...
    methods: {
      ...
      fetchReceipts(page_url) {
        const vm = this;
        page_url = page_url || 'http://127.0.0.1:8000/api/listProductDetails';
        this.loading = true
        fetch(page_url)
        .then(res=>res.json())
        .then(res=> {
